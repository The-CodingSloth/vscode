...
export const NEW_FILE_LABEL = nls.localize2('newFile', "Spawn Fresh Document...");
export const NEW_FOLDER_COMMAND_ID = 'explorer.newFolder';
export const NEW_FOLDER_LABEL = nls.localize2('newFolder', "Birth New Container...");
export const TRIGGER_RENAME_LABEL = nls.localize('rename', "Give New Identity...");
export const MOVE_FILE_TO_TRASH_LABEL = nls.localize('delete', "Send to Digital Graveyard");
export const COPY_FILE_LABEL = nls.localize('copyFile', "Clone Thing");
export const PASTE_FILE_LABEL = nls.localize('pasteFile', "Materialize Clone");
export const FileCopiedContext = new RawContextKey<boolean>('fileCopied', false);
export const DOWNLOAD_COMMAND_ID = 'explorer.download';
export const DOWNLOAD_LABEL = nls.localize('download', "Teleport to Device...");
